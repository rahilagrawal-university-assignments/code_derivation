...
\begin{gather*}
  \color{blue}isPrime(r) = 
     ...
     \end{cases}
\end{gather*}\\
The $reversen(r,s)$ function provided (and proven true) in 18s1 Assignment 2 Spec can be used to occupy the reverse of a number $r$ in a variable called $s$.\\\\
...
\subsection{\color{blue}Implication 8\color{black}: $\myRefines{Inv\subst{x+1}{x} \And a=1}{a=1 \And x>0}$}
\begin{align*}
...
\subsection{\color{blue}Implication 23\color{black}: $\myRefines{\post(3)}{\post(3)}$}
\begin{align*}
