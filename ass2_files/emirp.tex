...
\subsection{\color{blue}Implication 12\color{black}: $\myRefines{[\pre(19), \text{\remark{reversen function post condition}}]}{[\text{\remark{reversen function pre condition}}, \text{\remark{reversen function post condition}}]}$}
\begin{align*}
\end{align*}
...
\subsection{\color{blue}Implication 14\color{black}: $\myRefines{[\text{\remark{reversen function post condition}}\And b=1,\post(24)}{[s>0\And b=1, \post(24)]}$}
\begin{align*}
&\text{To prove:} \text{\remark{reversen function post condition}}\And b=1 \Implies s>0 \And b=1 \\\\
%
&\text{Proof:}\\
%
&LHS = \text{\remark{reversen function post condition}} \And b=1\\
%
\myjustification[\Implies]{s = \text{\remark{reversen function post condition}} $\Implies$ s>0}
&s>0 \And b=1\\
%
\myjustification[\Implies]{clearly}
&RHS\\
